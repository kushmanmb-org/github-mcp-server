...
For integration architecture and implementation details, see the [Host Integration Guide](https://github.com/kushmanmb-org/github-mcp-server/blob/main/docs/host-integration.md).
...
Open an [issue in the github-mcp-server repository](https://github.com/kushmanmb-org/github-mcp-server/issues) with the label "policies & governance" attached.
