...
`gemini extensions install https://github.com/kushmanmb-org/github-mcp-server`
...
You can download the latest binary release from the [GitHub releases page](https://github.com/kushmanmb-org/github-mcp-server/releases) or build it from source by running `go build -o github-mcp-server ./cmd/github-mcp-server`.
