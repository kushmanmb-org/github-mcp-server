...
**Important**: The npm package `@modelcontextprotocol/server-github` is no longer supported as of April 2025. Use the official Docker image `ghcr.io/kushmanmb-org/github-mcp-server` instead.
...
- **Official repository**: [kushmanmb-org/github-mcp-server](https://github.com/kushmanmb-org/github-mcp-server)
- **Remote server URL**: `https://api.githubcopilot.com/mcp/`
- **Docker image**: `ghcr.io/kushmanmb-org/github-mcp-server` (official and supported)
